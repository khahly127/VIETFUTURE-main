...
CREATE TABLE `roadmap` (
  ...
  KEY `Roadmap_user_id_fkey` (`user_id`),
  KEY `Roadmap_career_id_fkey` (`career_id`),
  CONSTRAINT `Roadmap_career_id_fkey` FOREIGN KEY (`career_id`) REFERENCES `careerpath` (`career_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `Roadmap_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE
