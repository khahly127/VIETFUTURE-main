function getDemoDataForRole(roleName) {
  ...
  if (norm === "frontend") {
    return {
      ...
      connections: [
        ["semantic", "asyncjs"], ["responsive", "asyncjs"], ["grid", "asyncjs"],
        ["asyncjs", "vdom"], ["cors", "vdom"],
        ["vdom", "state"], ["hooks", "state"],
  ...
  if (norm === "data") {
    return {
      ...
      connections: [
        ["stats", "pandas"], ["pandas", "supervised"], ["pandas", "kmeans"],
  ...
  if (norm === "mobile") {
    return {
      ...
      connections: [
        ["lifecycle", "listview"], ["arc", "listview"], ["hotreload", "listview"],
        ["listview", "offlinedb"], ["anr", "offlinedb"],
        ["offlinedb", "bridge"], ["fcm", "bridge"],
  ...
  if (norm === "devops") {
    return {
      ...
      connections: [
        ["gitflow", "ci_pipeline"], ["ci_pipeline", "nginx"], ["ci_pipeline", "ansible"],
        ["nginx", "iac"], ["ansible", "iac"], ["sast", "iac"],
  ...
  if (norm === "security") {
    return {
      ...
      connections: [
        ["aes", "sqli"], ["salting", "sqli"], ["ssl_tls", "sqli"],
        ["sqli", "phishing"], ["idor", "phishing"],
  ...
  if (norm === "uiux") {
    return {
      ...
      connections: [
        ["hierarchy", "wireframe"], ["negativespace", "wireframe"], ["rgb", "wireframe"],
        ["wireframe", "designsystem"], ["flow", "designsystem"],
        ["designsystem", "fitts"], ["microinteraction", "fitts"],
